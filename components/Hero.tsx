  ...
  return (
    ...
    >
      ...
      >
        <motion.p
          variants={item}
          className="mb-5 text-xs font-bold uppercase tracking-[0.4em] text-gold-400 sm:text-sm"
        >
          Deeksharambh 2026
        </motion.p>
        ...
        <motion.h1
          variants={item}
          className="font-display text-5xl font-bold italic leading-[1.08] text-gold-500 drop-shadow-[0_6px_30px_rgba(212,175,55,0.25)] sm:text-6xl md:text-7xl lg:text-8xl"
        >
